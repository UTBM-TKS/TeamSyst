...
ORDER BY
  ...
  delete SHOP_FACTS where ID=90001;
delete SHOP_FACTS where ID=90000;

delete OUTLET_LOOKUP where SHOP_CODE=400;
delete OUTLET_LOOKUP where SHOP_CODE=401;

delete ARTICLE_LOOKUP where ARTICLE_CODE=102;
delete ARTICLE_LOOKUP where ARTICLE_CODE=103;

delete ARTICLE_COLOR_LOOKUP where ARTICLE_CODE=101;
